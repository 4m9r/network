        ...
        while(true){
            ...
            for(int i =0; i < httpGetSplit.length; i++){
                ...
                if(httpGetSplit[i].equals("string"))
                    toServer = httpGetSplit[i + 1];
            }

            String fromTheServer;
            if(hostName != null && serverPort != 0 && httpGetSplit[0].equals("GET") && 
            httpGetSplit[httpGetSplit.length - 2].equals("HTTP")){
                ...
                if(toServer == null){
                    ...
                    System.out.println(fromTheServer);
                    sb.append(fromTheServer);
                }
            }
            else
